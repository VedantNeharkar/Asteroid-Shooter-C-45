...
spaceImage = loadImage("Sprites/sky.png");
earth = loadImage("Sprites/earth.jpg");
asteroid1 = loadImage("Sprites/asteroid.jpg");
asteroid2 = loadImage("Sprites/asteroid.jpg");
asteroid3 = loadImage("Sprites/asteroid.jpg");
explosionImage = loadImage("Sprites/blst.jpg");
laserImage = loadImage("Sprites/fire.jpg");
...
if(gameState === instruction) {
  ...
  textSize(50);
  text("------Guardians OF Galaxy------",canvas.width/2,canvas.height/2);
  text("ENJOY THE GAME!",canvas.width/2,canvas.height/2+100);
  stroke("yellow");
  fill("yellow");
  textSize(35);
